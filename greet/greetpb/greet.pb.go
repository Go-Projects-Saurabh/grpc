...
var file_greet_greetpb_greet_proto_rawDesc = []byte{
	...
	0x51, 0x0a, 0x0e, 0x47, 0x72, 0x65, 0x61, 0x74, 0x4d, 0x61, 0x6e, 0x79, 0x54, 0x69, 0x6d, 0x65,
...
var file_greet_greetpb_greet_proto_depIdxs = []int32{
	...
	3, // 3: greet.GreetService.GreatManyTimes:input_type -> greet.GreetManyTimesRequest
	2, // 4: greet.GreetService.Greet:output_type -> greet.GreetResponse
	4, // 5: greet.GreetService.GreatManyTimes:output_type -> greet.GreetManyTimesResponse
...
func (*UnimplementedGreetServiceServer) GreatManyTimes(*GreetManyTimesRequest, GreetService_GreatManyTimesServer) error {
	return status.Errorf(codes.Unimplemented, "method GreatManyTimes not implemented")
}
